...
class MCP23008(object):
    ...
    def __init__(self,busId,address):
        ...
        self._bus = smbus.SMBus(1)
        self._address = 0x20
        self._bus.write_byte_data(self._address,0x01,0x00) #Output
        self._bus.write_byte_data(self._address, 0x09,0x00)

    def readA(self):
     #   print('ReadA',self._bus.read_byte_data(self._address,0x12))
        return self._bus.read_byte_data(self._address,0x09)

    def writeA(self,value):
       # print('writeA',value)
        self._bus.write_byte_data(self._address,0x09,value)
